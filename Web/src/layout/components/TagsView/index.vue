<template>
  <div id="tags-view-container" class="tags-view-container">
    ...
    <ul v-show="visible" :style="{ left: left + 'px', top: top + 'px' }" class="contextmenu">
      ...
      <li @click="closeAllTags(selectedTag)"><circle-close style="width: 1em; height: 1em" /> {{ $t('tagsView.closeAll')
      }}</li>
    </ul>
  </div>
</template>
...
function openMenu(tag, e) {
  ...
  const offsetLeft = containerRect.left // container margin left
  const offsetWidth = containerRect.width // container width
