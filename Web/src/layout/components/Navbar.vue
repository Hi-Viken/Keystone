<template>
  <div class="navbar" :data-theme="sideTheme" :class="appStore.device + ' nav' + settingsStore.navType">
    ...
    <div class="right-menu">
      ...
      <Notice :title="$t('common.tips')" class="right-menu-item" />
      <template v-if="appStore.device == 'desktop'">
        <zr-git :title="$t('common.sourceCode')" class="right-menu-item" />
        <zr-doc :title="$t('common.docAddress')" class="right-menu-item" />
        <screenfull :title="$t('common.fullScreen')" class="right-menu-item" />
      </template>
      <size-select :title="$t('common.layoutSize')" class="right-menu-item" />
      <LangSelect :title="$t('common.language')" class="right-menu-item" />
          ...
          <template #dropdown>
            <el-dropdown-menu>
              ...
              <el-dropdown-item command="copyToken" v-if="dev">
                <span>{{ $t('layout.copyToken') }}</span>
              </el-dropdown-item>
              <el-dropdown-item command="clear">
                <span>{{ $t('layout.clearCache') }}</span>
              </el-dropdown-item>
