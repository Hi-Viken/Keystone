...
using SkyFrpPanel.Service.Content.IService;
using SkyFrpPanel.Service.Social.IService;
using SkyFrpPanel.Model.Enum;
...
namespace SkyFrpPanel.Controllers
{
    ...
    public class FrontArticleController : BaseController
    {
        ...
        public IActionResult Create([FromBody] ArticleDto parm)
        {
            ...
            addModel.ArticleType = ArticleTypeEnum.Article;
        ...
        {
            var userId = HttpContext.GetUId();
            var fansInfo = _FansInfoService.GetFirst(f => f.Userid == toUserid) ?? new SocialFansInfo() { };
