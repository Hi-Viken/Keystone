...
using SqlSugar;
using SkyFrpPanel.CodeGenerator;
using SkyFrpPanel.CodeGenerator.Model;
using SkyFrpPanel.CodeGenerator.Service;
using SkyFrpPanel.Model;
using SkyFrpPanel.Model.System.Dto;
using SkyFrpPanel.Model.System.Generate;

namespace SkyFrpPanel.Controllers
{
    /// <summary>
    /// 代码生成
    /// </summary>
    ...
    public class CodeGeneratorController : BaseController
    {
        ...
        [HttpGet("list")]
        [ActionPermissionFilter(Permission = "tool:gen:list")]
        public IActionResult GetGenTable([FromForm]string tableName, [FromForm] PagerInfo pagerInfo)
        {
        ...
        public IActionResult CodeGenerate([FromBody] GenerateDto dto)
        {
            ...
            //生成压缩包
            string zipReturnFileName = $"SkyFrpPanel-{dto.GenTable.TableName}-{DateTime.Now:MMddHHmmss}.zip";
