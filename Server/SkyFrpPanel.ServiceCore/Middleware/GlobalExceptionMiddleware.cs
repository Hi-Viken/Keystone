...
namespace SkyFrpPanel.ServiceCore.Middleware
{
    /// <summary>
    /// 全局异常处理中间件
    ...
    public class GlobalExceptionMiddleware
    {
        ...
        private async Task HandleExceptionAsync(HttpContext context, Exception ex)
        {
            ...
            int StatusCode = (int)ResultCode.GLOBAL_ERROR;
            string message;
            ...
            //else
            //if (ex is FuException FuException)
            //{
            //    code = FuException.Code;
            //    msg = FuException.Message;
            //}
            else
            ...
            else
            {
                ...
                message = "服务器好像出了点问题，请联系系统管理员...";
                error = $"异常原因：{ex.Message}{an1}";
                logLevel = LogLevel.Error;
                context.Response.StatusCode = 500;
            }

            ApiResult apiResult = new(code, message);
#if DEBUG
            ...
            SysOperLog sysOperLog = new()
            {
                ...
                ErrorMsg = string.IsNullOrEmpty(error) ? message : error,
